            ...
            <div id="layoutSidenav_content">
                <main>
                   <div class="container-fluid">
                    <h2 style="text-align: center;">Diagnosis Trimester 2</h2>
                    <form method="post" action="fuzzy2.php">
                        <label><input type="checkbox" name="gejala2[]" value="G12"> Pendarahan</label><br>
                        <label><input type="checkbox" name="gejala2[]" value="G13"> Tidak ada nyeri</label><br>
                        <label><input type="checkbox" name="gejala2[]" value="G14"> Darah kehitaman</label><br>
                        <label><input type="checkbox" name="gejala2[]" value="G15"> Tidak merasakan janin</label><br>
